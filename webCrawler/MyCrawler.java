...
public class MyCrawler extends WebCrawler {
	...
	private static final Pattern FILTERS = Pattern.compile(".*(\\.(css|js|xml|json|rss" + "|mp3|mp3|zip|gz))$");
    ...
    public boolean shouldVisit(Page referringPage, WebURL url) {
        ...
        String type="OutUSC";
        if(href.contains("http://www.nytimes.com") || href.contains("https://www.nytimes.com") 
        		|| href.contains("http://nytimes.com") || href.contains("https://nytimes.com"))
        {
        	type="OK";
        }
        else
...
//                System.out.println("text/html" + urlInfo);
            }
...
//                System.out.println("text/html" + urlInfo);
        ...
        else if(contentType.contains("image/jpg"))
        {
        	...
        	crawlState.visitedUrls.add(urlInfo);
//        	System.out.println("img" + urlInfo);
        }
...
//            urlInfo = new UrlInfo(url, page.getContentData().length, outgoingUrls, "unknown", "");
            urlInfo = new UrlInfo(url, page.getContentData().length, outgoingUrls, "unknown", contentType);
            crawlState.visitedUrls.add(urlInfo);
        }
